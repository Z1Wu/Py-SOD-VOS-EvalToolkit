...
def generate_cv2_file():
    ...
    file_name_list = [
        ...
        # 'sun_bepsjlnfypehmpgt', # small horse
        # 'sun_axftbpasnkrpiacj', # complex scene
        # 'sun_aabitsznxycbxvgm', # thread like
        # 'ILSVRC2012_test_00032180', # low contrast
        # 'sun_bjlmzdshfkrokwvh', # big, board-connected region

        'ILSVRC2012_test_00048578', # low contrast & thread like
        'ILSVRC2012_test_00005780', #  and comlex boundry (ant)
        'sun_bffqmlxnqvqwhsek', # small look ambious
        'sun_bepsjlnfypehmpgt', # small horse
        'ILSVRC2012_test_00036696', # big bird
        'ILSVRC2012_test_00095958', # normal dog
        'ILSVRC2012_test_00011906', 
        'ILSVRC2012_test_00032520', 
        'sun_alcpbxhmsofmrdfl', 
    ...
    gt_dir = f'data/{ds_name}/mask/'
    im_num = 6
    for idx, file_name in enumerate(file_name_list[:img_num]):
        im = read_img(im_dir, file_name + '.jpg')
        gt = read_img(gt_dir, file_name + '.png')
